...
namespace Tomes
{
    public class BlockGutenbergY2West : Block
    {
        ...
        public override void OnBlockBroken(IWorldAccessor world, BlockPos pos, IPlayer byPlayer, float dropQuantityMultiplier = 1)
        {
            ...
            if (variant == "north")
            {
                ...
                Block block = world.BlockAccessor.GetBlock(pos.AddCopy(1, -1, 0)) as BlockGutenbergPress;
                if (block != null) block.OnBlockBroken(world, pos.AddCopy(1, -1, 0), byPlayer, dropQuantityMultiplier);
            
            } else if (variant == "east") {
                // Variant is east
                Block block = world.BlockAccessor.GetBlock(pos.AddCopy(0, -1, 1)) as BlockGutenbergPress;
                if (block != null) block.OnBlockBroken(world, pos.AddCopy(0, -1, 1), byPlayer, dropQuantityMultiplier);
