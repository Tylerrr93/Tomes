...
namespace Tomes
{
    public class BlockGutenbergY2 : Block 
    {
        ...
        public override void OnBlockBroken(IWorldAccessor world, BlockPos pos, IPlayer byPlayer, float dropQuantityMultiplier = 1)
        {
            ...
            if (variant == "north")
            {
                ...
                Block block = world.BlockAccessor.GetBlock(pos.AddCopy(0, -1, 0)) as BlockGutenbergPress;
                if (block != null) block.OnBlockBroken(world, pos.AddCopy(0, -1, 0), byPlayer, dropQuantityMultiplier);
